...
echo -e "***** Note: chmod +x this script firstly and performed with \033[31mroot\033[0m privilege ! *****"
...
case "$ANSWER" in
  [yY] | [yY][eE][sS])
    ...
    echo "***** \033[32mStart over, exit!\033[0m *****"
    ;;
  [nN] | [nN][oO])
    echo "***** Your choice is : \033[34mStop MPS\033[0m *****"
    echo quit | nvidia-cuda-mps-control
    nvidia-smi -i 0 -c DEFAULT
    echo "***** \033[34mStop over, exit!\033[0m *****"
    ;;
  *)
    echo "***** \033[31mInvalid Choice : Exit!\033[0m *****"
    ;;
esac
